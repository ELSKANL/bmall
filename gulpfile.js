...
gulp.task("php", function(){
	gulp.src("projectserver/**/*.php")
		.pipe(gulp.dest("dist/projectserver"))
		.pipe(connect.reload());
})
...
gulp.task("watch", function(){
	...
	gulp.watch("projectserver/**/*.php", ["php"]);
	gulp.watch("app/js/**/*.js", ["js"]);
	gulp.watch("app/module/**/*.js", ["module"]);
	gulp.watch("app/images/**/*", ["img"]);
})

gulp.task("default", ["html", "css", "js", "module", "img", "libs", "server", "watch","php"]);